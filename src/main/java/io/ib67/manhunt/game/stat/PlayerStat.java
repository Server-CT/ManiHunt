...
public class PlayerStat {
    ...
    public final static List<String> mentionedNormal = Arrays.asList("story/upgrade_tools", "story/smelt_iron", "story/lava_bucket",
            "story/enter_the_nether", "nether/obtain_blaze_rod", "story/follow_ender_eye", "story/enter_the_end");
    public final static List<String> mentionedSpecial = Arrays.asList("story/mine_diamond", "story/enchant_item"
